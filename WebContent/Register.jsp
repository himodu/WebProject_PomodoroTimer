...
<body>
	<div id="top">
		<div id="status">회원가입 하세요.</div>		
	</div>
	<div id="middle">
		<div id="LoginFrom">
			<form action="<%=request.getContextPath() %>/register.do"  method="post" name="loginFrm" >
				<div id="title">회원 가입</div>
				</br>
				<div class="mb-3">
				  <label for="formGroupExampleInput" class="form-label">이름</label>
				  <input type="text" class="form-control" name="name" placeholder="사용할 이름을 입력하세요">
				</div>
				<div class="mb-3">
